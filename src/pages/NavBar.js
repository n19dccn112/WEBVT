...
export default class NavBar extends Component {
  ...
  render() {
    return (
        <nav
            className="navbar navbar-expand-lg bg-transparent navbar-sticky navbar-airy navbar-light bg-hover-white bg-fixed-white navbar-hover-light navbar-fixed-light">
          <div className="container-fluid">
            ...
            <a className="navbar-toggler navbar-toggler-right" type="button" data-bs-toggle="collapse"
               data-bs-target="#navbarCollapse" aria-controls="navbarCollapse" aria-expanded="false"
               aria-label="Toggle navigation"><i className="fa fa-bars"></i></a>

            <div className="collapse navbar-collapse" id="navbarCollapse">
              <ul className="navbar-nav mx-auto">
                {this.nav}
                {this.curruser && <li className='nav-item'>
                  <a className='nav-link' href="/customer" onClick={(e) => this.logOut()}>Log Out</a>
                </li>}
              </ul>
