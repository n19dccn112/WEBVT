            ...
            <div className="container">
              <div className="row">
                <div className="col-lg-4 mb-5 mb-lg-0">
                  <div className="fw-bold text-uppercase text-lg text-dark mb-3">Sell<span
                      className="text-primary">.</span></div>
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing.</p>
                  <ul className="list-inline">
                    <li className="list-inline-item"><Link className="text-muted text-primary-hover"
                                                           to="#" target="_blank" title="twitter"><i
                        className="fab fa-twitter"></i></Link></li>
                    <li className="list-inline-item"><Link className="text-muted text-primary-hover"
                                                           to="#" target="_blank" title="facebook"><i
                        className="fab fa-facebook"></i></Link></li>
                    <li className="list-inline-item"><Link className="text-muted text-primary-hover"
                                                           to="#" target="_blank" title="instagram"><i
                        className="fab fa-instagram"></i></Link></li>
                    <li className="list-inline-item"><Link className="text-muted text-primary-hover"
                                                           to="#" target="_blank" title="pinterest"><i
                        className="fab fa-pinterest"></i></Link></li>
                    <li className="list-inline-item"><Link className="text-muted text-primary-hover"
                                                           to="#" target="_blank" title="vimeo"><i
                        className="fab fa-vimeo"></i></Link></li>
                  </ul>
                </div>
