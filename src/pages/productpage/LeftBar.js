    ...
    return (
        <>
          ...
          <div className="sidebar col-xl-3 col-lg-4 order-lg-1">
            <div className="sidebar-block px-3 px-lg-0 me-lg-4"><a className="d-lg-none block-toggler"
                                                                   data-bs-toggle="collapse"
                                                                   href="#categoriesMenu" aria-expanded="false"
                                                                   aria-controls="categoriesMenu">Product
              Categories</a>
              <div className="expand-lg collapse" id="categoriesMenu">
                <div className="nav nav-pills flex-column mt-4 mt-lg-0" role="menu">
                  <div className="sidebar-menu-item mb-2" role="menuitem"><a className="nav-link"
                                                                             href="#!"
                                                                             onClick={(e) => this.props.filterByCate(undefined)}><span>All</span></a>
                  </div>
            ...
            <div className="sidebar-block px-3 px-lg-0 me-lg-4"><a className="d-lg-none block-toggler"
                                                                   ...
                                                                   aria-controls="brandFilterMenu">Filter by
              Feature</a>
            ...
            <div className="sidebar-block px-3 px-lg-0 me-lg-4"><a className="d-lg-none block-toggler"
                                                                   ...
                                                                   aria-controls="sizeFilterMenu">Filter by
              size</a>
                ...
                <form className="mt-4 mt-lg-0" action="#">
                  <div className="mb-1">
                    <div className="form-check">
                      <input className="form-check-input" id="size0" type="radio" name="size"
                             defaultChecked/>
