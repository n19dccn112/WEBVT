          ...
          <section className="hero">
            <div className="container">
              ...
              <div className="hero-content pb-5 text-center">
                ...
                <div className="row">
                  <div className="col-xl-8 offset-xl-2"><p className="lead text-muted">Lorem ipsum dolor
          ...
          <div className="container-fluid">
            <div className="row">
              ...
              <div className="products-grid col-xl-9 col-lg-8 order-lg-2">
                ...
                <div className="row">
                  <ProductList categoryId={this.state.categoryId} featureIds={this.state.featureIds}
                               key={this.state.featureIds} ref={this.productList}
                               openModel={(id) => this.openModel(id)}/>
                </div>
              ...
              <LeftBar filterByCate={(id) => this.handleFilterByCate(id)}
                       checkedFeature={(e, id) => this.handleFilterbyFeature(e, id)}/>
