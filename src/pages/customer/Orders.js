                    ...
                    {this.state.orders.map((order, index) => (
                            ...
                            <tr key={index}>
                              ...
                              <td className="py-4 align-middle"><span
                                  className={`badge p-2 text-uppercase ${this.label[order.status]}`}>{order.status}</span>
                              </td>
                              <td className="py-4 align-middle"><a className="btn btn-outline-dark btn-sm"
                                                                   href={`/orders/${order.orderId}`}>View</a>
                              </td>
                            </tr>
                        )
                    )}
