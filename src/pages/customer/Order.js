                              ...
                              <div className="row d-flex align-items-center text-center">
                                <div className="col-6">
                                  <div className="d-flex align-items-center"><a
                                      href="detail.html"><img className="cart-item-img"
                                                              src={Image} alt="..."/></a>
                                    <div className="cart-title text-start"><a
                                        className="text-uppercase text-dark"
                                        href="detail.html"><strong>{item.name}</strong></a>
                                    </div>
                                  </div>
                                </div>
                                <div className="col-2"><NumberFormat value={item.price}
                                                                     displayType={'text'}
                                ...
                                <div className="col-2 text-center"><NumberFormat
                                    value={item.price * item.amount} displayType={'text'}
