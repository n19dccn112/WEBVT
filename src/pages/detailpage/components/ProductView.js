            ...
            <div>
              ...
              <div
                ...
                <ul className="list-inline mb-2 mb-sm-0">
                  <li className="list-inline-item h4 fw-light mb-0"><NumberFormat
                      value={this.props.product.price} displayType={'text'} thousandSeparator={true}
                      prefix='$'/></li>
                  <li className="list-inline-item text-muted fw-light">
                    <del><NumberFormat value={this.props.product.price} displayType={'text'}
                                       thousandSeparator={true} prefix='$'/></del>
                  </li>
                </ul>
                <div className="d-flex align-items-center">
                  {this.state.stars}
                  <span
                      className="text-muted text-uppercase text-sm">{this.props.totalReview} reviews</span>
                </div>
              </div>
              <p className="mb-4 text-muted">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              ...
              <div className="row">
                ...
                <div className="col-12 col-lg-6 detail-option mb-5">
                  <label
                      className="detail-option-heading fw-bold">Items <span>(required)</span> Remain:<span>{this.props.product.remain}</span></label>
                  <input className="form-control detail-quantity" name="items" type="number"
                         onChange={(e) => this.handleChange(e)} value={this.state.amoutItem}/>
                </div>
              ...
              <ul className="list-inline">
                <li className="list-inline-item">
                  <a className="btn btn-dark btn-lg mb-1" onClick={() => this.add2Cart()}> <i
                      className="fa fa-shopping-cart me-2"></i>Add to Cart</a>
                </li>
