            ...
            <form className="form" id="contact-form" method="post" onSubmit={(e) => this.handlePostReview(e)}>
                ...
                <div className="col-sm-6">
                  <div className="mb-4">
                    ...
                    <input className="form-control" type="text" name="name" id="name"
                           placeholder="Enter your name" value={this.state.name}
                           onChange={(e) => this.onChangeName(e)} readOnly={true} required="required"/>
                  </div>
                </div>
                <div className="col-sm-6">
                  <div className="mb-4">
              ...
              <div className="mb-4">
                ...
                <input className="form-control" type="email" name="email" id="email"
                       value={this.state.email} onChange={(e) => this.onChangeEmail(e)} readOnly={true}
