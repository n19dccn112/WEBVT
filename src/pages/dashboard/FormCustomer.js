        ...
        <><Message isShow={this.state.isShow} type={this.state.type} message={this.state.message}
          ...
          <div className="block mb-5">
            <div className="block-header"><strong
                className="text-uppercase">{this.props.match.params.id ? 'Edit' : 'New'} Customer</strong></div>
            <div className="block-body">
              ...
              >
                  ...
                  <div className="col-sm-6">
                    <div className="mb-4">
                      <label className="form-label"
                             htmlFor="repassword">{this.props.match.params.id ? 'Change Password' : 'Confirm Password'}</label>
                      <Input
                          className={this.props.match.params.id ? "form-check-input" : "form-control"}
                          name="repassword"
                          id="repassword"
                ...
                <div className="row">
                  ...
                  <div className="col-sm-6">
                    <div className="mb-4" value={this.state.role}
                         onChange={(e) => this.roleOnChange(e)}>
                      ...
                      <div className="row">
                        {
                          this.roles.map((rl, index) =>
                                  ...
                                  (this.state.role.includes(rl) ?
                                      <div key={index} className="col-sm-6"><input key={index}
                ...
                <div className="text-center mt-4">
                  <Button className="btn btn-outline-dark" type="submit"><i
                      className="far fa-save me-2"></i>Save</Button>
                </div>
