        ...
        <><Message isShow={this.state.isShow} type={this.state.type} message={this.state.message}
          ...
          <div className="block mb-5">
            <div className="block-header"><strong
                className="text-uppercase">{this.props.match.params.id ? 'Edit' : 'New'} Product</strong></div>
            <div className="block-body">
              ...
              >
                  ...
                  <div className="col">
                    ...
                    />
                      ...
                      {this.state.showProgess &&
                          <PulseLoader color='aqua' loading={this.state.showProgess} css={override}
                                       size={15}/>}
                    </div>
                  </div>
                ...
                <FeatureTypeList isRadio={true} checkedFeature={(e) => this.handleFilterbyFeature(e)}
