                ...
                <div className="customer-sidebar card border-0">
                  ...
                  <nav className="list-group customer-nav">
                    <Link
                        ...
                        to="/dashboard/categories" onClick={() => this.resetCateComponent()}><span>
                    ...
                    <Link
                        className="list-group-item d-flex justify-content-between align-items-center text-decoration-none"
                        to="/dashboard/customers" onClick={() => this.resetUserComponent()}><span>
                                        <svg className="svg-icon svg-icon-heavy me-2">

                                        </svg>Manager Customer</span></Link>
                    <Link
                        className="list-group-item d-flex justify-content-between align-items-center text-decoration-none"
                        to="/dashboard/products" onClick={() => this.resetProductComponent()}><span>
                                        <svg className="svg-icon svg-icon-heavy me-2">
