          ...
          <section className="hero">
            <div className="container">
              ...
              <div className="hero-content pb-5 text-center">
                ...
                <div className="row">
                  <div className="col-xl-8 offset-xl-2"><p className="lead text-muted">You
                    have {this.state.products.length} items in your shopping cart</p></div>
                </div>
              </div>
            </div>
          </section>
              ...
              <div className="row mb-5">
                <div className="col-lg-8">
                              ...
                              <div className="row d-flex align-items-center text-center">
                                <div className="col-5">
                                  <div className="d-flex align-items-center"><a
                                      href={`/products/${product.productId}`}><img
                                      className="cart-item-img" src={Image} alt="..."/></a>
                                    <div className="cart-title text-start"><a
                                        className="text-uppercase text-dark"
                                        href={`/products/${product.productId}`}><strong>{product.fullName}</strong></a>
                                    </div>
                                  </div>
                                </div>
                                <div className="col-2"><NumberFormat value={product.price}
                                                                     displayType={'text'}
                                ...
                                <div className="col-2">
                                  <div className="d-flex align-items-center">
                                    <div className="btn btn-items btn-items-decrease"
                                         onClick={() => this.handleMinus(product.productId, product.remain)}>-
                                    </div>
                                    <input className="form-control text-center input-items"
                                           type="text"
                                           onChange={(e) => this.handleNumberItem(e, product.productId, product.remain)}
                                           value={this.state.items[product.productId]}/>
                                    <div className="btn btn-items btn-items-increase"
                                         onClick={() => this.handleAdd(product.productId, product.remain)}>+
                                    </div>
                                  </div>
                                </div>
                                <div className="col-2 text-center"><NumberFormat
                                    value={product.price * this.state.items[product.productId]}
                                    displayType={'text'} thousandSeparator={true} prefix='$'/>
                                </div>
                                <div className="col-1 text-center"><a className="cart-remove"
                                                                      onClick={() => this.handleRemove(product.productId)}>
                  ...
                  <div className="my-5 d-flex justify-content-between flex-column flex-lg-row"><a
                      className="btn btn-link text-muted" href="/products"><i
                      className="fa fa-chevron-left"></i> Continue Shopping</a><a className="btn btn-dark"
                                                                                  href="/checkout"
                                                                                  onClick={() => this.go2CheckOut()}>Proceed
                ...
                <div className="col-lg-4">
                  <div className="block mb-5">
                    ...
                    <div className="block-body bg-light pt-1">
                      <p className="text-sm">Shipping and additional costs are calculated based on
                        values you have entered.</p>
                      <ul className="order-summary mb-0 list-unstyled">
                        <li className="order-summary-item">
                          <span>Order Subtotal </span><span><NumberFormat value={this.state.total}
                                                                          displayType={'text'}
                                                                          thousandSeparator={true}
                                                                          prefix='$'/></span></li>
                        <li className="order-summary-item">
                          <span>Shipping and handling</span><span>$0.00</span></li>
                        ...
                        <li className="order-summary-item border-0"><span>Total</span><strong
                            className="order-summary-total"><NumberFormat value={this.state.total}
                                                                          displayType={'text'}
                                                                          thousandSeparator={true}
                                                                          prefix='$'/></strong></li>
                      </ul>
