              ...
              <div className="row">
                <div className="col-lg-8">
                  ...
                  <ul className="custom-nav nav nav-pills mb-5">
                    <li className="nav-item w-25"><span className="nav-link text-sm active"
                                                        href="checkout1.html">Address</span></li>
                  ...
                  <form>
                      ...
                      <div className="block-body">
                        <div className="row">
                          <div className="form-group col-md-6">
                            <label className="form-label" htmlFor="fullname_invoice">Full
                              Name</label>
                            <input className="form-control" type="text" name="fullname_invoice"
                                   placeholder="Joe Black" value={this.state.fullName}
                                   onChange={(e) => this.handleOnChangeName(e)} readOnly={true}
                                   id="fullname_invoice"/>
                          </div>
                          <div className="form-group col-md-6">
                            <label className="form-label" htmlFor="emailaddress_invoice">Email
                              Address</label>
                            <input className="form-control" type="text"
                                   name="emailaddress_invoice" value={this.state.email}
                                   onChange={(e) => this.handleOnChangeEmail(e)} readOnly={true}
                                   placeholder="joe.black@gmail.com" id="emailaddress_invoice"/>
                          </div>
                          <div className="form-group col-md-6">
                            <label className="form-label"
                                   htmlFor="street_invoice">Street</label>
                            <input className="form-control" type="text" name="street_invoice"
                                   value={this.state.address}
                                   onChange={(e) => this.handleOnChangeAddress(e)}
                                   placeholder="123 Main St." id="street_invoice"/>
                          </div>

                          <div className="form-group col-md-6">
                            <label className="form-label" htmlFor="phonenumber_invoice">Phone
                              Number</label>
                            <input className="form-control" type="text"
                    ...
                    <div className="mb-5 d-flex justify-content-between flex-column flex-lg-row"><a
                        ...
                        className="fa fa-angle-left me-2"></i>Back </a><a className="btn btn-dark"
                                                                          onClick={() => this.checkOut()}>Check
                      Out<i className="fa fa-angle-right ms-2"></i></a></div>
                  </form>
                </div>
                      ...
                      <ul className="order-summary mb-0 list-unstyled">
                        <li className="order-summary-item">
                          <span>Order Subtotal </span><span><NumberFormat value={this.state.total}
                                                                          ...
                                                                          prefix='$'/></span></li>
                        <li className="order-summary-item">
                          <span>Shipping and handling</span><span>$00.00</span></li>
