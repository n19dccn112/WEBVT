    ...
    if (this.props.isTable)
      return (
          ...
          <tr>
            ...
            <td className="py-4 align-middle"><NumberFormat value={this.props.price} displayType={'text'}
            ...
            <td className="py-4 align-middle">
              ...
              <a className="btn btn-outline-dark btn-sm"
                 onClick={(e) => this.props.deleteProduct(this.props.id)}>Delete</a>
            </td>
          </tr>
          ...
          <div className="col-xl-4 col-6">
            <div className="product">
              <div className="product-image">
                {this.props.remain === 0 ? <div className="ribbon ribbon-danger">Sold
                  out</div> : ''}{this.state.images.length > 0 ?
                  <img src={this.state.images[0].url} className="img-fluid" alt="product"/> :
                  <img src={Image} width="261px" height="391px" alt="product"/>}
                <div className="product-hover-overlay"><Link className="product-hover-overlay-link"
                                                             to={'/products/' + this.props.id}></Link>
                  <div className="product-hover-overlay-buttons">
                    <a className="btn btn-outline-dark btn-product-left d-none d-sm-inline-block"
                       href="/">
                    ...
                    <a className="btn btn-outline-dark btn-product-right d-none d-sm-inline-block"
                       onClick={(e) => this.props.openModel(this.props.id)} data-bs-toggle="modal"
                       data-bs-target="#exampleModal"><i className="fa fa-expand-arrows-alt"></i></a>
                  </div>
                </div>
              </div>
              <div className="py-2">
                ...
                <h3 className="h6 text-uppercase mb-1"><Link className="text-dark"
                                                             to={'/products/' + this.props.id}>{this.props.name}</Link>
                </h3><span className="text-muted">
