    ...
    if (this.props.isTable)
          ...
          <tr>
            ...
            <td className="py-4 align-middle">
              ...
              <a className="btn btn-outline-dark btn-sm"
                 onClick={(e) => this.props.deleteCate(this.props.id)}>Delete</a>
            </td>
          </tr>
      ...
      return (
          <div className="sidebar-menu-item mb-2" role="menuitem"><a className="nav-link"
                                                                     onClick={(e) => this.props.filterByCate(this.props.id)}>
            <span>{this.props.name}</span>{this.props.amount > 0 ?
              <span className="sidebar-badge ms-2">{this.props.amount}</span> : ''}</a></div>
      )
  }
}
